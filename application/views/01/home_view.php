...
<!DOCTYPE html>
<html>
<?php $this->load->view($template_folder."/_includes/head_home.php"); ?>
...
<body>
    ...
    <script type="text/javascript">
        backimage = '/uploads/user/home-slider/home-bg-01.jpg';
    </script>
    <?php $this->load->view($template_folder."/_includes/js_home.php"); ?>
</body>
