                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="card mt-30">
                            <div class="card-header">
                                ...
                                <div class="mt-2">
                                    <?php echo ($this->session->outletoriginid == -1) ? "ROOM" : "TABLE"; ?> # : <?php echo $order_master->table_num; ?>
                                </div>
                                <div class="mt-2">
                            ...
                            <div class="card mt-30">
                                <div class="card-body">
                                    ...
                                    foreach ($order_detail as $items) {
                                        if ($last_order) {
                                            $menu = $this->menu_model->get_by_id($items->menuid);
                                        ...
                                        ?>
                                                <div class="row mb-2">
                                                    <div class="col-12" style="font-weight: normal;">
                                                        <?php echo $subitem->subname; ?> :<br> <?php echo $subitem->itemname;
                                                                                                echo ($subitem->price > 0) ? " Rp. $subitem->price" : "" ?>
                                                    </div>
                                                </div>
