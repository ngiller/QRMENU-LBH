		...
		<script type="text/javascript">
      		...
      		$(document).ready(function() {
				...
				table = $('#table').DataTable({ 
					...
					"ajax": { "url": "<?php echo site_url('simin/usergroup/ajax_list')?>", "type": "POST" }, // Load data for the table's content from an Ajax source
					"columnDefs": [
			...
			function save() {
				...
				if(save_method == 'add') {
					url = "<?php echo site_url('simin/usergroup/add_save')?>";
				} else {
					url = "<?php echo site_url('simin/usergroup/ajax_update')?>";
				}
				...
				bootbox.confirm({
					...
					callback: function (result) {
						if(result) {
							...
							$.ajax({
								url : "<?php echo site_url('simin/usergroup/delete')?>/"+id,
								type: "POST",
								dataType: "JSON",
								success: function(data) {									
									reload_table();
					...
					callback: function (result) {
						if (result) {
							...
							if(id.length === 0) {
								...
								// ajax delete data to database
								$.ajax({
									url : "<?php echo site_url('simin/usergroup/del_selected')?>",
									type: "POST",
									dataType: "JSON",
									data:{id:id},
									success: function(data) {									
			...
			function edit_record(id) {
				...
				$.ajax({
					url : "<?php echo site_url('simin/usergroup/ajax_edit/')?>/" + id,
					type: "GET",
					dataType: "JSON",
					success: function(data)
					{			
				...
				<div class="modal-body form">
					<form action="#" id="form" class="form-horizontal">
						...
						<div class="form-group">												
							...
							<input type="text" class="form-control" name="name" required="true" id="name" placeholder="group name">																				
