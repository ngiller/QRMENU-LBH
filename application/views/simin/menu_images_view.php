									...
									<div class="kt-section">
										<div class="kt-section__content">
											<div class="form-group row">
												...
												<div class="col-2">
													<a href="javascript:open_popup('/assets/vendors/general/filemanager/dialog.php?type=2&popup=1&field_id=image&folder=01&akey=jPqtaZXzm5YazS8i2dI0w44ZfJDI2WK0p66mhulsA49lWP9LASCphpuH2ZgS')" class="btn btn-success btn-sm" type="button">Select</a>
												</div>
											</div>
											<div class="form-group row">
