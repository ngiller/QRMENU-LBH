...
class Menu_cat_images_model extends CI_Model {
    
	var $table = 'menu_cat_images';
    ...
    function get_order_by_pos($catid) {	
    ...
    function save($catid, $active, $pos, $image) {
        $data = array(
            'active'=> $active,
            'catid' => $catid,
            'position' => $pos,             
    ...
    public function count_all($catid) {
		$this->db->where('catid', $catid);
		$this->db->from($this->table);
    ...
    public function get_next_pos($catid) {
